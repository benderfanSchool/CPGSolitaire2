...
<<<<<<< HEAD
	...
	{
		String sqlStatementOne = "create user '" + username + "'@'" + InetAddress.getLocalHost() + "' identified by '" + password + "';";
		String sqlStatementTwo = "grant select,insert,update on scores_database.scores to '" + username + "'@'" + USERURL + "';";
		ResultSet rs;
